...
fn chal_12() {
    ...
    let target = encrypt_ecb_with_unknown_key(&mut data_clone);
    ...
    let res = encrypt_ecb_with_unknown_key(&mut chunk);
    ...
    for byte in 0..=255 {
        ...
        let res = encrypt_ecb_with_unknown_key(&mut buffer_clone);
